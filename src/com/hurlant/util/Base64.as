package com.hurlant.util
{
   ...
   public class Base64
   {
      ...
      public static function encodeByteArray(param1:ByteArray) : String
      {
         ...
         while(_loc3_ < _loc5_)
         {
            _loc6_ = Number(param1[int(_loc3_++)]) << 16 | Number(param1[int(_loc3_++)]) << 8 | Number(param1[int(_loc3_++)]);
         ...
         {
            _loc6_ = Number(param1[int(_loc3_++)]) << 8 | Number(param1[int(_loc3_)]);
      ...
      public static function decodeToByteArray(param1:String) : ByteArray
      {
         ...
         while(_loc6_ < _loc7_)
         {
            ...
            if((_loc4_ = int(_loc8_[int(_loc6_++)])) == 61)
            {
               break;
            }
