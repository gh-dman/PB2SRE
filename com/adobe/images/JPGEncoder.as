package com.adobe.images
{
   ...
   public class JPGEncoder
   {
      ...
      private function initQuantTables(param1:int) : void
      {
         ...
         while(_loc2_ < 64)
         {
            _loc3_ = Math.floor((Number(_loc4_[_loc2_]) * param1 + 50) / 100);
            if(_loc3_ < 1)
            {
               _loc3_ = 1;
            }
         ...
         while(_loc2_ < 64)
         {
            _loc3_ = Math.floor((Number(_loc5_[_loc2_]) * param1 + 50) / 100);
            if(_loc3_ < 1)
            {
               _loc3_ = 1;
            }
         ...
         while(_loc7_ < 8)
         {
            ...
            while(_loc8_ < 8)
            {
               this.fdtbl_Y[_loc2_] = 1 / (Number(this.YTable[this.ZigZag[_loc2_]]) * Number(_loc6_[_loc7_]) * Number(_loc6_[_loc8_]) * 8);
               this.fdtbl_UV[_loc2_] = 1 / (Number(this.UVTable[this.ZigZag[_loc2_]]) * Number(_loc6_[_loc7_]) * Number(_loc6_[_loc8_]) * 8);
               _loc2_++;
               _loc8_++;
            }
            _loc7_++;
      ...
      private function writeBits(param1:BitString) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            {
               this.bytenew |= uint(1 << Number(this.bytepos));
            }
            _loc3_--;
            --this.bytepos;
            if(this.bytepos < 0)
      ...
      private function fDCTQuant(param1:Array, param2:Array) : Array
      {
         ...
         while(_loc22_ < 8)
         {
            ...
            _loc10_ = Number(param1[_loc23_ + 0]) - Number(param1[_loc23_ + 7]);
            _loc4_ = param1[_loc23_ + 1] + param1[_loc23_ + 6];
            _loc9_ = Number(param1[_loc23_ + 1]) - Number(param1[_loc23_ + 6]);
            _loc5_ = param1[_loc23_ + 2] + param1[_loc23_ + 5];
            _loc8_ = Number(param1[_loc23_ + 2]) - Number(param1[_loc23_ + 5]);
            _loc6_ = param1[_loc23_ + 3] + param1[_loc23_ + 4];
            _loc7_ = Number(param1[_loc23_ + 3]) - Number(param1[_loc23_ + 4]);
         ...
         while(_loc22_ < 8)
         {
            ...
            _loc10_ = Number(param1[_loc23_ + 0]) - Number(param1[_loc23_ + 56]);
            _loc4_ = param1[_loc23_ + 8] + param1[_loc23_ + 48];
            _loc9_ = Number(param1[_loc23_ + 8]) - Number(param1[_loc23_ + 48]);
            _loc5_ = param1[_loc23_ + 16] + param1[_loc23_ + 40];
            _loc8_ = Number(param1[_loc23_ + 16]) - Number(param1[_loc23_ + 40]);
            _loc6_ = param1[_loc23_ + 24] + param1[_loc23_ + 32];
            _loc7_ = Number(param1[_loc23_ + 24]) - Number(param1[_loc23_ + 32]);
            _loc11_ = _loc3_ + _loc6_;
            _loc14_ = _loc3_ - _loc6_;
            _loc12_ = _loc4_ + _loc5_;
            _loc13_ = _loc4_ - _loc5_;
         ...
         while(_loc22_ < 64)
         {
            param1[_loc22_] = Math.round(Number(param1[_loc22_]) * Number(param2[_loc22_]));
            _loc22_++;
         }
         return param1;
      }
      ...
      private function processDU(param1:Array, param2:Array, param3:Number, param4:Array, param5:Array) : Number
      {
         ...
         var _loc10_:int = Number(this.DU[0]) - param3;
